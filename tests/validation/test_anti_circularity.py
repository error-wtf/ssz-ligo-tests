...
class TestAntiCircularityRules:
    ...
    def test_posterior_fields_not_direct_observables(self):
        ...
        posterior_f = 251.0  # Example value from posterior file
        posterior_m = 68.0   # Example value
        posterior_chi = 0.69 # Example value
...
class TestModelLockRequirement:
    ...
    def test_no_post_hoc_adjustment(self):
        ...
        data_f = 260.0  # Some measured frequency
        
        # Predicted
        predicted_f = model.ssz_ringdown_frequency_shift(251.0)
